...
export default function Home() {
  ...
  return (
    <Fragment>
      <Head>
        <title>LifeSolver</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className="bg-gradient-to-r from-indigo-200 via-red-200 to-yellow-100 min-h-screen px-4 py-16 sm:px-6 sm:py-24 md:grid md:place-items-center lg:px-8">
        <main className="flex flex-col justify-center  max-w-3xl w-full align-center">
          <h1 className="text-4xl text-center font-extrabold text-slate-800 drop-shadow sm:text-5xl mb-1">
            LifeSolver, the ultimate cheat-sheet for everything
          </h1>
          <p className="block text-sm text-center font-medium text-gray-500">
            Add a description of your problem with the context behind it
          </p>
          ...
          <div className="text-center relative backdrop-filter overflow-hidden mb-6 max-w w-full rounded-md  ring-1 ring-black ring-opacity-0 p-4 ">
            ...
            <button
              className="inline-flex mt-5 items-center px-4 py-2 border border-gray-700 shadow-sm text-base font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none bg-neutral-200 py-4 border-neutral-400  text-neutral-600 hover:text-white hover:shadow-[inset_13rem_0_0_0] hover:shadow-blue-400 duration-[400ms,700ms]"  
            ...
            <div className="mt-5 p-5 text-sm text-gray-900 border-t-2 border-slate-200 animate-pulse ">
